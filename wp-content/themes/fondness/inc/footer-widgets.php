...
class Fondness_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'fondness';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'fondness' ), $i ),
...
// Initialize.
$fondness_footer_widgets = new Fondness_Footer_Widgets();