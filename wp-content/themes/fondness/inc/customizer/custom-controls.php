 ...
 */
class Fondness_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Fondness_Dropdown_Category_Control extends WP_Customize_Control {
...
class Fondness_Note_Control extends WP_Customize_Control {
...
class Fondness_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Fondness_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="fondness-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Fondness_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Fondness_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Fondness_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Fondness_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
